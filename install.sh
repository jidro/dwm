...
sudo eopkg install xorg-server xorg-server-devel xinit libx11-devel libxft-devel libxinerama-devel make cmake feh acpi upower gcc g++dejavu-fonts-ttf xsetroot picom pkg-config
