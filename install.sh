...
sudo pkg install git xorg xorg-server xinit libX11 libXft libXinerama cmake gccmakedep gmake feh acpi_call acpica-tools upower xsetroot picom rofi autoconf dejavu wqy-fonts
